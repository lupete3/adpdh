...
@foreach(['adpdh.css', 'refinements.css', 'pages.css', 'cms-home.css', 'cms-activities.css'] as $css)<link rel="stylesheet" href="{{ asset('adpdh/assets/'.$css) }}?v={{ filemtime(public_path('adpdh/assets/'.$css)) }}">@endforeach
