...
class CmsTitlesController extends Controller {
 ...
 public function edit(CmsPage $page) { if($page->key==='que-faisons-nous')return redirect()->route('admin.cms.work'); if($page->key==='qui-sommes-nous')return redirect()->route('admin.cms.about'); if($page->key==='index')return redirect()->route('admin.cms.home'); return view('cms.titles.edit', ['page'=>$page->load('titles')]); }
