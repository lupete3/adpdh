...
class CmsSection extends Model {
 protected $fillable = ['cms_page_id', 'key', 'label', 'template', 'eyebrow', 'title', 'title_accent', 'introduction', 'body', 'media_asset_id', 'image_caption', 'image_note_title', 'image_note_text', 'collection', 'buttons', 'is_visible', 'sort_order'];
