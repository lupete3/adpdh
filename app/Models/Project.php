...
class Project extends Model
{
 ...
 public function scopePubliclyVisible($q){return $q->forCms()->where('publication_state','published')->where('is_demo',false)->where(fn($q) => $q->whereNull('published_at')->orWhere('published_at','<=',now()));}
}
